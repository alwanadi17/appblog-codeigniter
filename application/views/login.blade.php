...
<main class="form-signin w-100 m-auto">
  <form method="post" action="{{ site_url('login') }}">
    <img class="mb-4" src="https://e7.pngegg.com/pngimages/509/403/png-clipart-semarang-university-faculty-of-information-and-communication-technology-resume-college-soekarno-resume-logo.png" alt="" width="90" height="96">
